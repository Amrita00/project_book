 ...
 */
final class Version20211123065124 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rent_book (id INT AUTO_INCREMENT NOT NULL, book_id INT DEFAULT NULL, user_id INT DEFAULT NULL, rent_book DATE NOT NULL, return_date DATE NOT NULL, INDEX IDX_BB8F0D7A16A2B381 (book_id), INDEX IDX_BB8F0D7AA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
